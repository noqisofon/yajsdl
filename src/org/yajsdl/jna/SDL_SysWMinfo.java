...
public class SDL_SysWMinfo extends Structure {
	...
	public static class info_union extends Union {
		...
		public static class x11_struct extends Structure {
			...
			protected void initFieldOrder() {
				setFieldOrder(new java.lang.String[]{"display", "window", "lock_func", "unlock_func", "fswindow", "wmwindow", "gfxdisplay"});
			}
			/**
			 * @param display < The X11 display<br>
			 * C type : Display*<br>
			 * @param window < The X11 display window<br>
			 * C type : Window<br>
			 * @param lock_func @{<br>
			 * C type : lock_func_callback<br>
			 * @param unlock_func C type : unlock_func_callback<br>
			 * @param fswindow @{<br>
			 * < The X11 fullscreen window<br>
			 * C type : Window<br>
			 * @param wmwindow < The X11 managed input window<br>
			 * C type : Window<br>
			 * @param gfxdisplay @{<br>
			 * < The X11 display to which rendering is done<br>
			 * C type : Display*
			 */
			public x11_struct(Pointer display, NativeLong window, SDL_SysWMinfo.info_union.x11_struct.lock_func_callback lock_func, SDL_SysWMinfo.info_union.x11_struct.unlock_func_callback unlock_func, NativeLong fswindow, NativeLong wmwindow, Pointer gfxdisplay) {
				super();
	...
	/**
	 * @param version C type : SDL_version<br>
	 * @param subsystem C type : SDL_SYSWM_TYPE<br>
	 * @param info C type : info_union
	 */
