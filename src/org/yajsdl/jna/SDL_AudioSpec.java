...
public class SDL_AudioSpec extends Structure {
     ...
     *            * Once the callback returns, the buffer will no longer be
     *            valid.<br>
    ...
    protected void initFieldOrder() {
        setFieldOrder( new java.lang.String[] { "freq", "format", "channels", "silence", "samples", "padding", "size",
            "callback", "userdata" } );
    }
     ...
     *            C type : void*
     */
    public SDL_AudioSpec(int freq, short format, byte channels, byte silence, short samples, short padding, int size,
            SDL_AudioSpec.callback_callback callback, Pointer userdata) {
        super();
        this.freq = freq;
        this.format = format;
