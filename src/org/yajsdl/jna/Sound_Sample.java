...
public class Sound_Sample extends Structure {
    ...
    protected void initFieldOrder() {
        setFieldOrder( new java.lang.String[] { "opaque", "decoder", "desired", "actual", "buffer", "buffer_size",
            "flags" } );
    }
     ...
     *            C type : Sound_SampleFlags
     */
    public Sound_Sample(Pointer opaque, org.yajsdl.jna.Sound_DecoderInfo.ByReference decoder, Sound_AudioInfo desired,
            Sound_AudioInfo actual, Pointer buffer, int/* Uint32 */buffer_size, int flags) {
        super();
        this.opaque = opaque;
