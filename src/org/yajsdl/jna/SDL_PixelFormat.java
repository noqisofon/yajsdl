...
public class SDL_PixelFormat extends Structure {
    ...
    protected void initFieldOrder() {
        setFieldOrder( new java.lang.String[] { "palette", "BitsPerPixel", "BytesPerPixel", "Rloss", "Gloss", "Bloss",
            "Aloss", "Rshift", "Gshift", "Bshift", "Ashift", "Rmask", "Gmask", "Bmask", "Amask", "colorkey", "alpha" } );
    }
