...
public interface SDLLibrary extends Library {
    ...
    public static final int SDL_INIT_EVENTTHREAD = 0x01000000;
     ...
     * @return
     */
    Pointer/* char* */SDL_AudioDriverName(ByteBuffer/* char* */namebuf, int maxlen);
     ...
     * @return
     */
    int/* SDL_audiostatus */SDL_GetAudioStatus();
     ...
     * @return
     */
    SDL_AudioSpec SDL_LoadWAV_RW(SDL_RWops src, int freesrc, SDL_AudioSpec spec, PointerByReference/*
                                                                                                    * Uint8
                                                                                                    * *
                                                                                                    * *
                                                                                                    */audio_buf,
            IntByReference/* Uint32* */audio_len);
     ...
     * @return
     */
    int SDL_BuildAudioCVT(SDL_AudioCVT cvt, short/* Uint16 */src_foramt, byte/* Uint8 */src_channels, int src_rate,
     ...
     * @param code
     */
    void SDL_Error(int/* SDL_errorcode */code);
    ...
    public static interface SDL_EventMask {
        ...
        public static final int SDL_KEYEVENTMASK        = ( 1 << ( SDL_EventType.SDL_KEYDOWN ) )
                                                                | ( 1 << ( SDL_EventType.SDL_KEYUP ) );
        ...
        public static final int SDL_MOUSEEVENTMASK      = ( 1 << ( SDL_EventType.SDL_MOUSEMOTION ) )
                                                                | ( 1 << ( SDL_EventType.SDL_MOUSEBUTTONDOWN ) )
                                                                | ( 1 << ( SDL_EventType.SDL_MOUSEBUTTONUP ) );
        ...
        public static final int SDL_JOYEVENTMASK        = ( 1 << ( SDL_EventType.SDL_JOYAXISMOTION ) )
                                                                | ( 1 << ( SDL_EventType.SDL_JOYBALLMOTION ) )
                                                                | ( 1 << ( SDL_EventType.SDL_JOYHATMOTION ) )
                                                                | ( 1 << ( SDL_EventType.SDL_JOYBUTTONDOWN ) )
                                                                | ( 1 << ( SDL_EventType.SDL_JOYBUTTONUP ) );
     ...
     * @return
     */
    int SDL_JoystickIndex(Pointer/* SDL_Joystick* */joystick);
     ...
     * @return
     */
    short/* Sint16 */SDL_JoystickGetAxis(Pointer/* SDL_Joystick* */joystick, int axis);
     ...
     * @return
     */
    byte/* Uint8 */SDL_JoystickGetHat(Pointer/* SDL_Joystick* */joystick, int hat);
     ...
     * @return
     */
    int SDL_JoystickGetBall(Pointer/* SDL_Joystick* */joystick, int ball, IntByReference/*
                                                                                         * int
                                                                                         * *
                                                                                         */dx, IntByReference/*
                                                                                                              * int
     ...
     * @return
     */
    byte/* Uint8 */SDL_JoystickGetButton(Pointer/* SDL_Joystick* */joystick, int button);
     ...
     * @return
     */
    ByteByReference/* Uint8* */SDL_GetKeyState(IntBuffer/* int* */numkeys);
     ...
     * @return
     */
    ByteByReference/* char* */SDL_GetKeyName(int/* SDLKey */key);
    ...
    public static interface SDLKey {
        /**
         * @name ASCII mapped keysyms The keyboard syms have been cleverly chosen
         *       to map to ASCII
         */
        /* @{ */
     ...
     * @return
     */
    Pointer/* void* */SDL_LoadFunction(Pointer/* void* */handle, String/*
                                                                        * const
                                                                        * char*
                                                                        */name);
    ...
    // * Windows 用。
    // */
    // int SDL_RegisterApp(String/* char* */ name, Uint32 style, Pointer/* void*
    // */ hInst);
     ...
     * @return
     */
    SDL_Cursor SDL_CreateCursor(ByteBuffer/* Uint8* */data, ByteBuffer/* Uint8* */mask, int w, int h, int hot_x,
            int hot_y);
    ...
    public static final int SDL_SWSURFACE         = 0x00000000;
    /** < Surface is in system memory */
    public static final int SDL_HWSURFACE         = 0x00000001;
    /** < Surface is in video memory */
    public static final int SDL_ASYNCBLIT         = 0x00000004;
    /** < Use asynchronous blits if possible */

    public static final int SDL_ANYFORMAT         = 0x10000000;
    /** < Allow any video depth/pixel-format */
    public static final int SDL_HWPALETTE         = 0x20000000;
    /** < Surface has exclusive palette */
    public static final int SDL_DOUBLEBUF         = 0x40000000;
    /** < Set up double-buffered video mode */
    public static final int SDL_FULLSCREEN        = 0x80000000;
    /** < Surface is a full screen display */
    public static final int SDL_OPENGL            = 0x00000002;
    /** < Create an OpenGL rendering context */
    public static final int SDL_OPENGLBLIT        = 0x0000000A;
    /** < Create an OpenGL rendering context and use it for blitting */
    public static final int SDL_RESIZABLE         = 0x00000010;
    /** < This video mode may be resized */
    public static final int SDL_NOFRAME           = 0x00000020;
    /** < No window caption or edge frame */

    public static final int SDL_HWACCEL           = 0x00000100;
    /** < Blit uses hardware acceleration */
    public static final int SDL_SRCCOLORKEY       = 0x00001000;
    /** < Blit uses a source color key */
    public static final int SDL_RLEACCELOK        = 0x00002000;
    /** < Private flag */
    public static final int SDL_RLEACCEL          = 0x00004000;
    /** < Surface is RLE encoded */
    public static final int SDL_SRCALPHA          = 0x00010000;
    /** < Blit uses source alpha blending */
    public static final int SDL_PREALLOC          = 0x01000000;
    ...
    public static final int SDL_YV12_OVERLAY = 0x32315659;
    /** < Planar mode: Y + V + U (3 planes) */
    public static final int SDL_IYUV_OVERLAY = 0x56555949;
    /** < Planar mode: Y + U + V (3 planes) */
    public static final int SDL_YUY2_OVERLAY = 0x32595559;
    /** < Packed mode: Y0+U0+Y1+V0 (1 plane) */
    public static final int SDL_UYVY_OVERLAY = 0x59565955;
    /** < Packed mode: U0+Y0+V0+Y1 (1 plane) */
    public static final int SDL_YVYU_OVERLAY = 0x55595659;
     ...
     * @return
     */
    Pointer/* char* */SDL_VideoDriverName(ByteBuffer/* char* */namebuf, int maxlen);
     ...
     */
    int SDL_SetGammaRamp(ShortBuffer/* const Uint16 */redtable, ShortBuffer/*
                                                                            * const
                                                                            * Uint16
                                                                            */greentable, ShortBuffer/*
                                                                                                      * const
                                                                                                      * Uint16
                                                                                                      */bluetable);
     ...
     */
    void SDL_GetRGBA(int pixel, SDL_PixelFormat fmt, ByteByReference r, ByteByReference g, ByteByReference b,
            ByteByReference a);
     ...
     */
    SDL_Surface SDL_CreateRGBSurface(int flags, int width, int height, int depth, int Rmask, int Gmask, int Bmask,
            int Amask);
     ...
     * 空の SDL_Surface オブジェクトを作成します。
     */
    SDL_Surface SDL_CreateRGBSurfaceFrom(Buffer/* void* */pixels, int flags, int width, int height, int depth,
