...
public class SDL_VideoInfo extends Structure {
    // / Conversion Error : hw_available:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         hw_available;
    // / Conversion Error : wm_available:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         wm_available;
    // / Conversion Error : UnusedBits1:6 (This runtime does not support bit
    // fields : JNA)
    // @Bits(6)
    public int                         UnusedBits;
    // / Conversion Error : UnusedBits2:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         UnusedBits2;
    // / Conversion Error : blit_hw:1 (This runtime does not support bit fields
    // : JNA)
    // @Bits(1)
    public int                         blit_hw;
    // / Conversion Error : blit_hw_CC:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         blit_hw_CC;
    // / Conversion Error : blit_hw_A:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         blit_hw_A;
    // / Conversion Error : blit_sw:1 (This runtime does not support bit fields
    // : JNA)
    // @Bits(1)
    public int                         blit_sw;
    // / Conversion Error : blit_sw_CC:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         blit_sw_CC;
    // / Conversion Error : blit_sw_A:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         blit_sw_A;
    // / Conversion Error : blit_fill:1 (This runtime does not support bit
    // fields : JNA)
    // @Bits(1)
    public int                         blit_fill;
    // / Conversion Error : UnusedBits3:16 (This runtime does not support bit
    // fields : JNA)
    // @Bits(16)
    ...
    protected void initFieldOrder() {
        setFieldOrder( new java.lang.String[] { "hw_available", "wm_available", "UnusedBits", "UnusedBits2", "blit_hw",
            "blit_hw_CC", "blit_hw_A", "blit_sw", "blit_sw_CC", "blit_sw_A", "blit_fill", "UnusedBits2", "video_mem",
            "vfmt", "current_w", "current_h" } );
    }
     ...
     * @param current_w
     *            < Value: The current video mode width<br>
     * @param current_h
     *            < Value: The current video mode height
     */
