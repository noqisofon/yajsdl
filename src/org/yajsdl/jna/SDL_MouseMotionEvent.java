...
public class SDL_MouseMotionEvent extends Structure {
	...
	/**
	 * @param type < SDL_MOUSEMOTION<br>
	 * C type : Uint8<br>
	 * @param which < The mouse device index<br>
	 * C type : Uint8<br>
	 * @param state < The current button state<br>
	 * C type : Uint8<br>
	 * @param x < The X/Y coordinates of the mouse<br>
	 * C type : Uint16<br>
	 * @param y < The X/Y coordinates of the mouse<br>
	 * C type : Uint16<br>
